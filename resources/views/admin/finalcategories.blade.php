...
@section('content')
    <div class="buttons">
        ...
        <a class="btn btn-primary button-link" type="button" href="/admin/categories/{{$mainCategory->id}}">
            Retourner vers la catégorie parente</a>
    </div>
    <div class="card">
        <div class="card-body">
    ...
    @foreach ($finalcategories as $category)
                    ...
                    <div class="modal-body">
                        <div class="card">
                            <form class="form-horizontal" method="POST"
                                action="/admin/finalcategories/{{ $category->id }}">
                                @csrf
                                @method('PUT')
        ...
        <div class="modal fade" id="delete-Modal{{ $category['id'] }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form action="/admin/finalcategories/{{ $category->id }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="modal-content">
                        <div class="modal-header">
    ...
    <div class="modal fade" id="add-Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <form class="form-horizontal" method="POST" action="/admin/finalcategories">
                            @csrf
                            <div class="card-body" id="product-form">
