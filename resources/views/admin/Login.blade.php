            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="{{ asset('images/logo/logo-small.png') }}" alt="logo" />
                            <h3 style="color: white">DZ RC Modélisme</h3>
                        </span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="/admin/dashboard">
                        ...
                        <div class="row p-b-30">
                            @error('failed')
                                <div class="mb-4"><span class="text-danger">Le nom d'utilisateur ou le mot de passe est
                                        incorrect.</span></div>
                            @enderror
                            <div class="col-12">
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success" href="#" id="to-login"
                                        name="action">Retourner</a>
                                    <button class="btn btn-info float-right" type="button"
                                        name="action">Envoyer</button>
                                </div>
                            </div>
                        </form>
                    </div>
